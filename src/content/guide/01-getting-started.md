...
The Model layer's write funnel is <a href="/guide/04-model-layer">Chapter 4</a>. Actions, Validators, and Action Controllers get their own treatment in <a href="/guide/05-actions-and-controllers">Chapter 5</a>. Re-entrancy and the concurrency primitives referenced above land in <a href="/guide/06-concurrency">Chapter 6</a>.
</div>
