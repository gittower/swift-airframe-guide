...
The manager/store split introduced here runs through <a href="/guide/05-model-layer">Chapter 5</a>, where the persisted, database-backed model shape is built on exactly that pair. Background controllers — the long-lived objects <em>started</em> in phase 4 — are covered next: <a href="/guide/04-background-controllers">Chapter 4</a>.
</div>
